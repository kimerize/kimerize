module github.com/kimerize/kimerize/examples

go 1.23.2

replace github.com/kimerize/kimerize => ../

require (
	github.com/kimerize/kimerize v0.0.0
	sigs.k8s.io/kustomize/api v0.19.0
	sigs.k8s.io/kustomize/kyaml v0.19.1-0.20250403085037-7372f97c19a0
)
...
require (
	...
	github.com/GoogleContainerTools/kpt-functions-catalog/functions/go/search-replace v0.0.0-20230830181247-3df40d5acf6b // indirect
	...
	github.com/google/k8s-digester v0.1.16 // indirect
...
tool github.com/google/k8s-digester
